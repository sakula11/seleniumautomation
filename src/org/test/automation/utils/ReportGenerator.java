...
public class ReportGenerator extends BrowserManager {
	...
	public static void main(String args[]) throws GmailException, IOException {
		...
		ArrayList<String> _Modules = new ArrayList<>();
		_Modules.add("Login");
		_Modules.add("Register");
		ArrayList<String> tCList = new ArrayList<>();
		tCList.add("8");
		tCList.add("5");
		ArrayList<Integer> totalList2 = new ArrayList<>();
		totalList2.add(4);
		totalList2.add(5);
		totalList2.add(3);

		ArrayList<Integer> passedList2 = new ArrayList<>();

		passedList2.add(4);
		passedList2.add(5);
		passedList2.add(3);

		ArrayList<Integer> failedList2 = new ArrayList<>();

		failedList2.add(4);
		failedList2.add(5);
		failedList2.add(3);

		ArrayList<Integer> skippedList2 = new ArrayList<>();
		...
		int sc = 1;
		int total = 22;
		ArrayList<String> totalTimeList2 = new ArrayList<>();

		totalTimeList2.add("5 min, 2 sec");

		totalTimeList2.add("15 min, 12 sec");

		totalTimeList2.add("8 min, 8 sec");

		String reportPath = "";
		ArrayList<String> exceptionList = new ArrayList<>();

		exceptionList.add("Element Not found");

		exceptionList.add("Element Not found");

		exceptionList.add("Element Not found");

		ArrayList<String> snapShotList2 = new ArrayList<>();

		snapShotList2.add("fdfdfdfdfd");

		snapShotList2.add("fdfdfdfdfd");

		snapShotList2.add("fdfdfdfdfd");

		String totalTimeTaken = "1 hour, 5 minutes";

		String msg = TimeUtils.getMessageBasedonTime();
		String tcDetails = "";
		/*
		 * writeToHTML(url, _Modules, tCList, totalList2, passedList2, failedList2,
		 * skippedList2, pc, fc, sc, total, totalTimeList2, reportPath, exceptionList,
		 * snapShotList2, totalTimeTaken, msg, tcDetails);
		 */

		String moduleName = "Login";
		ArrayList<String> tcNameList = new ArrayList<>();
		tcNameList.add("aa");
		tcNameList.add("bbb");
		tcNameList.add("ccc");
		ArrayList<String> executionStatusList = new ArrayList<>();
		executionStatusList.add("PASSED");
		executionStatusList.add("FAILED");
		executionStatusList.add("PASSED");

		tcDetails = TCwriteToHTML("Login", tcNameList, executionStatusList);

		writeToHTML(url, _Modules, tCList, totalList2, passedList2, failedList2, skippedList2, pc, fc, sc, total,
				totalTimeList2, reportPath, exceptionList, snapShotList2, totalTimeTaken, msg, tcDetails);
	}
